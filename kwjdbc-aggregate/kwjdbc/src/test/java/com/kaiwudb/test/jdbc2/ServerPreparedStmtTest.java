...
public class ServerPreparedStmtTest extends BaseTest4 {
  ...
  public void testEmptyResults() throws Exception {
    ...
    ((KWStatement) pstmt).setUseServerPrepare(true);
    for (int i = 0; i < 10; ++i) {
      pstmt.setInt(1, -1);
  ...
  public void testPreparedStatementsNoBinds() throws Exception {
    ...
    ((KWStatement) pstmt).setUseServerPrepare(true);
    assertTrue(((KWStatement) pstmt).isUseServerPrepare());
    ...
    if (Boolean.getBoolean("com.kaiwudb.forceBinary")) {
      return;
    }
    ((KWStatement) pstmt).setUseServerPrepare(false);
    assertTrue(!((KWStatement) pstmt).isUseServerPrepare());
