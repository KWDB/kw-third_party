...
/**
 * TestCase to test the internal functionality of org.kaiwudb.jdbc2.Connection and it's
 * superclass.
 */
public class ConnectionTest {
  ...
  public void testReadOnly_always() throws Exception {
    ...
    KWProperty.READ_ONLY_MODE.set(props, "always");
  ...
  public void testReadOnly_ignore() throws Exception {
    final Properties props = new Properties();
    KWProperty.READ_ONLY_MODE.set(props, "ignore");
    con = TestUtil.openDB(props);
    Statement st;
    ResultSet rs;
  ...
  public void testReadOnly_transaction() throws Exception {
    final Properties props = new Properties();
    KWProperty.READ_ONLY_MODE.set(props, "transaction");
    con = TestUtil.openDB(props);
    Statement st;
    ResultSet rs;
  ...
  public void testWarnings() throws Exception {
    ...
    ((KwConnection) con).addWarning(new SQLWarning(testStr));
