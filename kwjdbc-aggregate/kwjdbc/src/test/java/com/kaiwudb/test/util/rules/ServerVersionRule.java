...
package com.kaiwudb.test.util.rules;
...
/**
 * <p>Rule for ignore test if current version kaiwudb to old to use. And it necessary because
...
public class ServerVersionRule implements TestRule {
  ...
  public ServerVersionRule() {
    KwConnection connection = null;
    try {
      connection = (KwConnection) TestUtil.openDB();
