...
public class BaseTest4 {
  ...
  protected void updateProperties(Properties props) {
    ...
    if (stringType != null) {
      KWProperty.STRING_TYPE.set(props, stringType.name().toLowerCase());
    }
  }
  ...
  public void setUp() throws Exception {
    ...
    KWConnection kw = con.unwrap(KWConnection.class);
    preferQueryMode = kw == null ? PreferQueryMode.EXTENDED : kw.getPreferQueryMode();
  }
