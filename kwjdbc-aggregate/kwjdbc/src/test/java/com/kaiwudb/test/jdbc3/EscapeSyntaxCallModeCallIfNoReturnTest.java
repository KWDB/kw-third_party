...
public class EscapeSyntaxCallModeCallIfNoReturnTest extends EscapeSyntaxCallModeBaseTest {
  ...
  protected void updateProperties(Properties props) {
    ...
    KWProperty.ESCAPE_SYNTAX_CALL_MODE.set(props, EscapeSyntaxCallMode.CALL_IF_NO_RETURN.value());
  }
  ...
  public void testInvokeFunction() throws Throwable {
    ...
    try {
      ...
      assertTrue(ex.getSQLState().equalsIgnoreCase(KSQLState.WRONG_OBJECT_TYPE.getState()));
    }
  }
