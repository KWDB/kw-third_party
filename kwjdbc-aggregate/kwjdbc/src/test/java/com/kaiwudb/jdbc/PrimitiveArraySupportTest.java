...
public class PrimitiveArraySupportTest {
  ...
  public void testLongBinary() throws Exception {
    ...
    final KwArray kwArray = new KwArray(null, Oid.INT8_ARRAY, longArrays.toBinaryRepresentation(null, longs));

    Object arrayObj = kwArray.getArray();
  ...
  public void testIntBinary() throws Exception {
    ...
    final KwArray kwArray = new KwArray(null, Oid.INT4_ARRAY, intArrays.toBinaryRepresentation(null, ints));
  ...
  public void testShortToBinary() throws Exception {
    ...
    final KwArray kwArray = new KwArray(null, Oid.INT4_ARRAY, shortArrays.toBinaryRepresentation(null, shorts));
  ...
  public void testDoubleBinary() throws Exception {
    ...
    final KwArray kwArray = new KwArray(null, Oid.FLOAT8_ARRAY, doubleArrays.toBinaryRepresentation(null, doubles));
  ...
  public void testFloatBinary() throws Exception {
    ...
    final KwArray kwArray = new KwArray(null, Oid.FLOAT4_ARRAY, floatArrays.toBinaryRepresentation(null, floats));
  ...
  public void testBooleanBinary() throws Exception {
    ...
    final KwArray kwArray = new KwArray(null, Oid.BIT, booleanArrays.toBinaryRepresentation(null, bools));
