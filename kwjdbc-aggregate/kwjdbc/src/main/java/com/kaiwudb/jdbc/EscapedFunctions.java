...
public class EscapedFunctions {
  ...
  public static String sqlcurdate(List<?> parsedArgs) throws SQLException {
    if (!parsedArgs.isEmpty()) {
      throw new KSQLException(GT.tr("{0} function doesn''t take any argument.", "curdate"),
          KSQLState.SYNTAX_ERROR);
    }
    return "current_date";
  }
  ...
  public static String sqlcurtime(List<?> parsedArgs) throws SQLException {
    if (!parsedArgs.isEmpty()) {
      throw new KSQLException(GT.tr("{0} function doesn''t take any argument.", "curtime"),
          KSQLState.SYNTAX_ERROR);
    }
    return "current_time";
  }
  ...
  private static String constantToInterval(String type, String value) throws SQLException {
    ...
    if (SQL_TSI_DAY.equalsIgnoreCase(shortType)) {
      ...
      throw new KSQLException(GT.tr("Interval {0} not yet implemented", "SQL_TSI_FRAC_SECOND"),
          KSQLState.SYNTAX_ERROR);
    } else {
      throw new KSQLException(GT.tr("Interval {0} not yet implemented", type),
          KSQLState.SYNTAX_ERROR);
  ...
  public static String sqldatabase(List<?> parsedArgs) throws SQLException {
    if (!parsedArgs.isEmpty()) {
      throw new KSQLException(GT.tr("{0} function doesn''t take any argument.", "database"),
          KSQLState.SYNTAX_ERROR);
    }
  ...
  public static String sqluser(List<?> parsedArgs) throws SQLException {
    if (!parsedArgs.isEmpty()) {
      throw new KSQLException(GT.tr("{0} function doesn''t take any argument.", "user"),
          KSQLState.SYNTAX_ERROR);
    }
    return "user";
  }
  ...
  private static String singleArgumentFunctionCall(String call, String functionName,
      List<?> parsedArgs) throws KSQLException {
    if (parsedArgs.size() != 1) {
