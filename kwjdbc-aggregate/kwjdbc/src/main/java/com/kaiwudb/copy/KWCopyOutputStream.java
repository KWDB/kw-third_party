...
/**
 * OutputStream for buffered input into a KaiwuDB COPY FROM STDIN operation.
 */
public class KWCopyOutputStream extends OutputStream implements CopyIn {
  private CopyIn op;
   ...
   */
  public KWCopyOutputStream(KWConnection connection, String sql) throws SQLException {
   ...
   * @throws SQLException if initializing the operation fails
   */
  public KWCopyOutputStream(KWConnection connection, String sql, int bufferSize)
      throws SQLException {
   ...
   */
  public KWCopyOutputStream(CopyIn op) {
   ...
   * @param bufferSize try to send this many bytes at a time
   */
  public KWCopyOutputStream(CopyIn op, int bufferSize) {
    this.op = op;
