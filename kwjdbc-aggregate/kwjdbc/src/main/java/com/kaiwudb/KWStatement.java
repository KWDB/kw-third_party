...
/**
 * This interface defines the public KaiwuDB extensions to java.sql.Statement. All Statements
 * constructed by the KaiwuDB driver implement KWStatement.
 */
public interface KWStatement {
