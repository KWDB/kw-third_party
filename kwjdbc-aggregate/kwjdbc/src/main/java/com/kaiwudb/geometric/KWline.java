 ...
 **/
public class KWline extends KWobject implements Serializable, Cloneable {
  ...
  /**
   * @param s definition of the line in KaiwuDB's syntax.
  ...
  public boolean equals(Object obj) {
    ...
    return Double.compare(kWline.a, a) == 0
        && Double.compare(kWline.b, b) == 0
        && Double.compare(kWline.c, c) == 0;
  }
  ...
  /**
   * @return the KWline in the syntax expected by com.kaiwudb
   */
  @Override
