...
public class Fastpath {
  ...
  /**
   * Send a function call to the KaiwuDB backend.
   *
  ...
  /**
   * <p>Send a function call to the KaiwuDB backend by name.</p>
   *
   ...
   * backend.</p>
   *
   * <p>For an example of how this works, refer to LargeObject</p>
   *
   * @param name Function name
   * @param args FastpathArguments to pass to fastpath
   * @return null if no data, byte[] otherwise
   ...
   *
   * <p>KaiwuDB stores the function id's and their corresponding names in the kw_proc table. To
   ...
   *
   * <p>The LargeObject class performs a query upon it's startup, and passes
  ...
  public int getID(String name) throws SQLException {
    ...
    if (id == null) {
      throw new KSQLException(GT.tr("The fastpath function {0} is unknown.", name),
