...
import com.kaiwudb.jdbc.FieldMetadata;
 ...
 */
public interface BaseConnection extends KWConnection, Connection {
  /**
   ...
   * only since KaiwuDB version 9.1. Logical replication available only since KaiwuDB version 9.4.
   *
   ...
   * the types registered via {@link KWConnection#addDataType(String, Class)} and
   * {@link KWConnection#addDataType(String, String)}.</p>
   *
   * <p>If no class is registered as handling the given type, then a generic
   * {@link KWobject} instance is returned.</p>
   *
   ...
   *
   * <p>The input version is of the form xxyyzz, matching a KaiwuDB version like xx.yy.zz. So 9.0.12
   * is 90012.</p>
   *
   ...
   * traditional KaiwuDB escaping rules. Versions up to 8.1 always treated backslashes as escape
