...
public class messages_cs extends java.util.ResourceBundle {
  ...
  static {
    ...
    t[298] = "The authentication type {0} is not supported. Check that you have configured the kw_hba.conf file to include the client''s IP address or subnet, and that it is using an authentication scheme supported by the driver.";
    t[299] = "Ověření typu {0} není podporováno. Zkontrolujte zda konfigurační soubor kw_hba.conf obsahuje klientskou IP adresu či podsíť a zda je použité ověřenovací schéma podporováno ovladačem.";
