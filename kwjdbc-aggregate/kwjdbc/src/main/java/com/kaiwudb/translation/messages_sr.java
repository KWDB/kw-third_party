...
public class messages_sr extends java.util.ResourceBundle {
  ...
  static {
    ...
    t[187] = "KaiwuDB LOB mogu jedino da označavaju: {0}";
    ...
    t[519] = "Tip autentifikacije {0} nije podržan. Proverite dali imate podešen kw_hba.conf fajl koji uključuje klijentovu IP adresu ili podmrežu, i da ta mreža koristi šemu autentifikacije koja je podržana od strane ovog drajvera.";
