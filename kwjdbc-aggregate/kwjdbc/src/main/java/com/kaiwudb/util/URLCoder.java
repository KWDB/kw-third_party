 ...
 * encoding consistent across the driver, and encoding might be changed via {@code kaiwudb.url.encoding} property</p>
 *
 * <p>Note: this should not be used outside of KaiwuDB source, this is not a public API of the
 * driver.</p>
 */
public final class URLCoder {
  private static final String ENCODING_FOR_URL =
      System.getProperty("kaiwudb.url.encoding", "UTF-8");
