 ...
 *
 * <p>Refer to LargeObjectManager on how to gain access to a Large Object,
    ...
    if (!closed) {
      ...
      if (os != null) {
        try {
          ...
          throw new KSQLException("Exception flushing output stream", KSQLState.DATA_ERROR, ioe);
        } finally {
          os = null;
        }
      }
