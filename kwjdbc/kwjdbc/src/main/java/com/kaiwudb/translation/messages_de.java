...
public class messages_de extends java.util.ResourceBundle {
  ...
  static {
    ...
    t[187] = "LOBs in KaiwuDB können nur auf {0} verweisen.";
    ...
    t[519] = "Der Authentifizierungstyp {0} wird nicht unterstützt. Stellen Sie sicher, dass die Datei ''kw_hba.conf'' die IP-Adresse oder das Subnetz des Clients enthält und dass der Client ein Authentifizierungsschema nutzt, das vom Treiber unterstützt wird.";
