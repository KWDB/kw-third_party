...
import com.kaiwudb.core.v3.TypeTransferModeRegistry;
...
public interface QueryExecutor extends TypeTransferModeRegistry {
   ...
   *
   * @deprecated in KwJDBC 9.4 as we now auto-size batches.
   */
  @Deprecated
   ...
   *
   * <p>Note that there's no requirement for this to be numeric or of the form x.y.z. KaiwuDB
  ...
  // Expose parameter status to KWConnection
