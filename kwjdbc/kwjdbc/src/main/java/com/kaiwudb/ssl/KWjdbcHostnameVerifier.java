...
public class KWjdbcHostnameVerifier implements HostnameVerifier {
  private static final Logger LOGGER = Logger.getLogger(KWjdbcHostnameVerifier.class.getName());

  public static final KWjdbcHostnameVerifier INSTANCE = new KWjdbcHostnameVerifier();
  ...
  public static final Comparator<String> HOSTNAME_PATTERN_COMPARATOR = new Comparator<String>() {
    ...
    public int compare(String o1, String o2) {
      // The more the dots the better: a.b.c.kaiwudb.org is more specific than kaiwudb.org
      ...
      // The less the stars the better: kaiwudb.org is more specific than *.*.kaiwudb.org
      ...
      // The longer the better: kaiwudb.org is more specific than sql.org
      int l1 = o1.length();
      int l2 = o2.length();
      if (l1 != l2) {
        return l1 > l2 ? 1 : -1;
