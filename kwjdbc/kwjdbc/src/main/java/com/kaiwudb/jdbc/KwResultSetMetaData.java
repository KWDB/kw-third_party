...
import com.kaiwudb.util.Gettable;
import com.kaiwudb.util.GettableHashMap;
...
public class KwResultSetMetaData implements ResultSetMetaData, KWResultSetMetaData {
   ...
   */
  public KwResultSetMetaData(BaseConnection connection, Field[] fields) {
   ...
   * {@inheritDoc}
   *
   * <p>It is believed that KaiwuDB does not support this feature.
   *
...
//    return metadata != null && metadata.autoIncrement;
    throw Driver.notImplemented(this.getClass(), "isAutoIncrement(int)");
  }
  ...
  public boolean isCurrency(int column) throws SQLException {
    String typeName = getKWType(column);
   ...
   * {@inheritDoc}
   *
   * <p>Is the column a signed number? In KaiwuDB, all numbers are signed, so this is trivial.
...
//    return getBaseTableName(column);
    throw Driver.notImplemented(this.getClass(), "getTableName(int)");
  }
...
//    return metadata == null ? "" : metadata.tableName;
    throw Driver.notImplemented(this.getClass(), "getBaseTableName(int)");
  }
...
//    return type;
  ...
  protected String getKWType(int columnIndex) throws SQLException {
    return connection.getTypeInfo().getKWType(getField(columnIndex).getOID());
  }
  ...
  // This can hook into our KW_Object mechanism
