...
public class SchemaTest {
  ...
  public void testCurrentSchemaPropertyVisibilityTableDuringFunctionCreation() throws SQLException {
    Properties properties = new Properties();
    properties.setProperty(KWProperty.CURRENT_SCHEMA.getName(), "public,schema1,schema2");
  ...
  public void testCurrentSchemaPropertyNotVisibilityTableDuringFunctionCreation() throws SQLException {
    Properties properties = new Properties();
    properties.setProperty(KWProperty.CURRENT_SCHEMA.getName(), "public,schema2");
    ...
    try (Connection connection = TestUtil.openDB(properties)) {
      ...
      assertThat("Test creates function in schema 'schema2' and this function try use table \"check_table\" "
            ...
            + KSQLState.UNDEFINED_TABLE + ", because search_path does not contains schema 'schema1' and "
            + "kaiwudb does not see table \"check_table\"",
            sqlState,
            equalTo(KSQLState.UNDEFINED_TABLE.getState())
      );
      assertThat(
          "Test creates function in schema 'schema2' and this function try use table \"check_table\" "
              ...
              + "because search_path does not contains schema 'schema1' and kaiwudb does not see "
              + "table \"check_table\"",
            message,
  ...
  public void testCurrentSchemaPropertyNotVisibilityTableInsideFunction() throws SQLException {
    ...
    try (Connection connection = TestUtil.openDB(properties)) {
      ...
      assertThat("Test call function in schema 'schema2' and this function uses table \"check_table\" "
            + "from schema 'schema1'. We expect here sql error code - " + KSQLState.UNDEFINED_TABLE + ", "
            + "because search_path does not contains schema 'schema1' and kaiwudb does not see table \"check_table\".",
            sqlState,
            equalTo(KSQLState.UNDEFINED_TABLE.getState())
      );
      assertThat(
          "Test call function in schema 'schema2' and this function uses table \"check_table\" "
              ...
              + " search_path does not contains schema 'schema1' and kaiwudb does not see table \"check_table\"",
          message,
          containsString("\"check_table\"")
      );
    }
