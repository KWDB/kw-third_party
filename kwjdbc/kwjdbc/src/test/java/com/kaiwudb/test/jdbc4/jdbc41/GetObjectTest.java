...
public class GetObjectTest {
  ...
  public void testGetXml() throws SQLException {
    if (!TestUtil.haveMinimumServerVersion(conn, ServerVersion.v8_3)) {
      // XML column requires KaiwuDB 8.3+
      return;
    }
    Statement stmt = conn.createStatement();
  ...
  public void testGetMoney() throws SQLException {
    ...
    try {
      assertTrue(rs.next());
      KWmoney money = rs.getObject("money_column", KWmoney.class);
      assertTrue(money.getValue().endsWith(expected));

      money = rs.getObject(1, KWmoney.class);
      assertTrue(money.getValue().endsWith(expected));
    } finally {
      rs.close();
    }
  ...
  public void testGetPoint() throws SQLException {
    Statement stmt = conn.createStatement();
    KWpoint expected = new KWpoint(1.0d, 2.0d);
    ...
    try {
      assertTrue(rs.next());
      assertEquals(expected, rs.getObject("point_column", KWpoint.class));
      assertEquals(expected, rs.getObject(1, KWpoint.class));
    } finally {
      rs.close();
    }
  }
  ...
  public void testGetLine() throws SQLException {
    ...
    Statement stmt = conn.createStatement();
    KWline expected = new KWline(1.0d, 2.0d, 3.0d);
    ...
    try {
      assertTrue(rs.next());
      assertEquals(expected, rs.getObject("line_column", KWline.class));
      assertEquals(expected, rs.getObject(1, KWline.class));
    } finally {
      rs.close();
    }
  }
  ...
  public void testGetLineseg() throws SQLException {
    Statement stmt = conn.createStatement();
    KWlseg expected = new KWlseg(1.0d, 2.0d, 3.0d, 4.0d);
    ...
    try {
      assertTrue(rs.next());
      assertEquals(expected, rs.getObject("lseg_column", KWlseg.class));
      assertEquals(expected, rs.getObject(1, KWlseg.class));
    } finally {
      rs.close();
    }
  }
  ...
  public void testGetBox() throws SQLException {
    Statement stmt = conn.createStatement();
    KWbox expected = new KWbox(1.0d, 2.0d, 3.0d, 4.0d);
    ...
    try {
      assertTrue(rs.next());
      assertEquals(expected, rs.getObject("box_column", KWbox.class));
      assertEquals(expected, rs.getObject(1, KWbox.class));
    } finally {
      rs.close();
    }
  }
  ...
  public void testGetPath() throws SQLException {
    Statement stmt = conn.createStatement();
    KWpath expected = new KWpath(new KWpoint[]{new KWpoint(1.0d, 2.0d), new KWpoint(3.0d, 4.0d)}, true);
    ...
    try {
      assertTrue(rs.next());
      assertEquals(expected, rs.getObject("path_column", KWpath.class));
      assertEquals(expected, rs.getObject(1, KWpath.class));
    } finally {
      rs.close();
    }
  }
  ...
  public void testGetPolygon() throws SQLException {
    Statement stmt = conn.createStatement();
    KWpolygon expected = new KWpolygon(new KWpoint[]{new KWpoint(1.0d, 2.0d), new KWpoint(3.0d, 4.0d)});
    ...
    try {
      assertTrue(rs.next());
      assertEquals(expected, rs.getObject("polygon_column", KWpolygon.class));
      assertEquals(expected, rs.getObject(1, KWpolygon.class));
    } finally {
      rs.close();
    }
  }
  ...
  public void testGetCircle() throws SQLException {
    Statement stmt = conn.createStatement();
    KWcircle expected = new KWcircle(1.0d, 2.0d, 3.0d);
    ...
    try {
      assertTrue(rs.next());
      assertEquals(expected, rs.getObject("circle_column", KWcircle.class));
      assertEquals(expected, rs.getObject(1, KWcircle.class));
    } finally {
      rs.close();
    }
  }
  ...
  public void testGetInterval() throws SQLException {
    Statement stmt = conn.createStatement();
    KWInterval expected = new KWInterval(0, 0, 3, 4, 5, 6.0d);
    ...
    try {
      assertTrue(rs.next());
      assertEquals(expected, rs.getObject("interval_column", KWInterval.class));
      assertEquals(expected, rs.getObject(1, KWInterval.class));
    } finally {
      rs.close();
    }
  }
  ...
  private void testInet(String inet, InetAddress expectedAddr, String expectedText) throws SQLException, UnknownHostException {
    KWobject expectedObj = new KWobject();
