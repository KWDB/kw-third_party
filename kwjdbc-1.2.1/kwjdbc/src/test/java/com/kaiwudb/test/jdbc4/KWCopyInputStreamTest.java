...
import com.kaiwudb.copy.KWCopyInputStream;
...
public class KWCopyInputStreamTest {
  private Connection conn;
  private KWCopyInputStream sut;
  ...
  public void testReadBytesCorrectlyHandlesEof() throws SQLException, IOException {
    ...
    sut = new KWCopyInputStream((KWConnection) conn,
  ...
  private void silentlyCloseStream(KWCopyInputStream sut) {
    if (sut != null) {
      try {
        if (sut.isActive()) {
          sut.close();
