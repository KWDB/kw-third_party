...
/*
 * TestCase to test the internal functionality of com.kaiwudb.jdbc2.DatabaseMetaData
 *
 */
public class DatabaseMetaDataTest {
  ...
  public void setUp() throws Exception {
    ...
    if (TestUtil.haveMinimumServerVersion(con, ServerVersion.v8_4)) {
      // RETURNS TABLE requires KaiwuDB 8.4+
      stmt.execute(
