 ...
 * KWProperty#REPLICATION} and {@link KWProperty#ASSUME_MIN_SERVER_VERSION}. Without it property
 * building replication stream fail with exception.
 */
public interface KWReplicationConnection {
  ...
  /**
   * <p>Create replication slot, that can be next use in {@link KWReplicationConnection#replicationStream()}</p>
   *
