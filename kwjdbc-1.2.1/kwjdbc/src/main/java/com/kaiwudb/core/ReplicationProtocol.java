...
public interface ReplicationProtocol {
   ...
   */
  KWReplicationStream startLogical(LogicalReplicationOptions options) throws SQLException;
   ...
   * @throws SQLException on error
   */
  KWReplicationStream startPhysical(PhysicalReplicationOptions options) throws SQLException;
}
