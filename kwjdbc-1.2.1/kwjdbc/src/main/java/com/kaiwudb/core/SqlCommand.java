...
public class SqlCommand {
  ...
  public boolean returnsRows() {
    return parsedSQLhasRETURNINGKeyword || commandType == SqlCommandType.SELECT || commandType == SqlCommandType.WITH;
  }
  ...
  private SqlCommand(SqlCommandType type, boolean isBatchedReWriteConfigured,
    ...
    boolean batchedReWriteCompatible = (type == SqlCommandType.INSERT) && isBatchedReWriteConfigured
