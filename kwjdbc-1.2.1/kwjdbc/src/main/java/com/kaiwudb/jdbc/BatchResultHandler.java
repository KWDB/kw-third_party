...
public class BatchResultHandler extends ResultHandlerBase {
  ...
  private final KwStatement kwStatement;
  ...
  private KwResultSet generatedKeys;
  ...
  private KwResultSet latestGeneratedKeysRs;

  BatchResultHandler(KwStatement kwStatement, Query[] queries, ParameterList[] parameterLists,
                     boolean expectGeneratedKeys) {
    this.kwStatement = kwStatement;
  ...
  public void handleResultRows(Query fromQuery, Field[] fields, List<byte[][]> tuples,
    ...
    if (generatedKeys == null) {
      try {
        ...
        latestGeneratedKeysRs = (KwResultSet) kwStatement.createResultSet(fromQuery, fields,
  ...
  public void handleCommandStatus(String status, long updateCount, long insertOID) {
    ...
    if (resultIndex >= queries.length) {
      handleError(new KSQLException(GT.tr("Too many update results were returned."),
  ...
  private boolean isAutoCommit() {
    try {
      return kwStatement.getConnection().getAutoCommit();
    } catch (SQLException e) {
      assert false : "kwStatement.getConnection().getAutoCommit() should not throw";
      return false;
    }
  }
  ...
  public void handleWarning(SQLWarning warning) {
    kwStatement.addWarning(warning);
  }
