 ...
 * Note: this is a kwjdbc-internal class, so it is not supposed to be used outside of the driver.
 */
public final class EscapedFunctions2 {
  ...
  public static void sqlinsert(StringBuilder buf, List<? extends CharSequence> parsedArgs) throws SQLException {
    if (parsedArgs.size() != 4) {
      throw new KSQLException(GT.tr("{0} function takes four and only four argument.", "insert"),
          KSQLState.SYNTAX_ERROR);
    }
    buf.append("overlay(");
  ...
  public static void sqlleft(StringBuilder buf, List<? extends CharSequence> parsedArgs) throws SQLException {
    if (parsedArgs.size() != 2) {
      throw new KSQLException(GT.tr("{0} function takes two and only two arguments.", "left"),
          KSQLState.SYNTAX_ERROR);
    }
  ...
  public static void sqllength(StringBuilder buf, List<? extends CharSequence> parsedArgs) throws SQLException {
    if (parsedArgs.size() != 1) {
      throw new KSQLException(GT.tr("{0} function takes one and only one argument.", "length"),
          KSQLState.SYNTAX_ERROR);
    }
  ...
  public static void sqllocate(StringBuilder buf, List<? extends CharSequence> parsedArgs) throws SQLException {
    if (parsedArgs.size() == 2) {
      ...
      throw new KSQLException(GT.tr("{0} function takes two or three arguments.", "locate"),
          KSQLState.SYNTAX_ERROR);
    }
  }
  ...
  public static void sqlright(StringBuilder buf, List<? extends CharSequence> parsedArgs) throws SQLException {
    if (parsedArgs.size() != 2) {
      throw new KSQLException(GT.tr("{0} function takes two and only two arguments.", "right"),
          KSQLState.SYNTAX_ERROR);
    }
  ...
  public static void sqlsubstring(StringBuilder buf, List<? extends CharSequence> parsedArgs) throws SQLException {
    ...
    if (argSize != 2 && argSize != 3) {
      throw new KSQLException(GT.tr("{0} function takes two or three arguments.", "substring"),
          KSQLState.SYNTAX_ERROR);
    }
  ...
  public static void sqldayname(StringBuilder buf, List<? extends CharSequence> parsedArgs) throws SQLException {
    if (parsedArgs.size() != 1) {
      throw new KSQLException(GT.tr("{0} function takes one and only one argument.", "dayname"),
          KSQLState.SYNTAX_ERROR);
    }
  ...
  /**
   * dayofweek translation adding 1 to kaiwudb function since we expect values from 1 to 7
   *
   * @param buf The buffer to append into
   * @param parsedArgs arguments
   * @throws SQLException if something wrong happens
  ...
  public static void sqldayofweek(StringBuilder buf, List<? extends CharSequence> parsedArgs) throws SQLException {
    if (parsedArgs.size() != 1) {
      throw new KSQLException(GT.tr("{0} function takes one and only one argument.", "dayofweek"),
          KSQLState.SYNTAX_ERROR);
    }
  ...
  public static void sqlmonthname(StringBuilder buf, List<? extends CharSequence> parsedArgs) throws SQLException {
    if (parsedArgs.size() != 1) {
      throw new KSQLException(GT.tr("{0} function takes one and only one argument.", "monthname"),
          KSQLState.SYNTAX_ERROR);
    }
  ...
  private static void appendInterval(StringBuilder buf, String type, String value) throws SQLException {
    if (!isTsi(type)) {
      throw new KSQLException(GT.tr("Interval {0} not yet implemented", type),
          KSQLState.SYNTAX_ERROR);
    }
  ...
  private static boolean appendSingleIntervalCast(StringBuilder buf, String cmp, String type, String value, String kwType) {
    if (!areSameTsi(type, cmp)) {
      return false;
    }
    buf.ensureCapacity(buf.length() + 5 + 4 + 14 + value.length() + kwType.length());
    buf.append("CAST(").append(value).append("||' ").append(kwType).append("' as interval)");
    return true;
  }
  ...
  private static void zeroArgumentFunctionCall(StringBuilder buf, String call, String functionName,
      List<? extends CharSequence> parsedArgs) throws KSQLException {
    if (!parsedArgs.isEmpty()) {
      throw new KSQLException(GT.tr("{0} function doesn''t take any argument.", functionName),
          KSQLState.SYNTAX_ERROR);
    }
    buf.append(call);
  }
  ...
  private static void singleArgumentFunctionCall(StringBuilder buf, String call, String functionName,
      List<? extends CharSequence> parsedArgs) throws KSQLException {
    if (parsedArgs.size() != 1) {
      throw new KSQLException(GT.tr("{0} function takes one and only one argument.", functionName),
          KSQLState.SYNTAX_ERROR);
    }
  ...
  private static void twoArgumentsFunctionCall(StringBuilder buf, String call, String functionName,
      List<? extends CharSequence> parsedArgs) throws KSQLException {
    if (parsedArgs.size() != 2) {
      throw new KSQLException(GT.tr("{0} function takes two and only two arguments.", functionName),
          KSQLState.SYNTAX_ERROR);
    }
