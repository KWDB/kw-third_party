...
class KwCallableStatement extends KwPreparedStatement implements CallableStatement {
  ...
  KwCallableStatement(KwConnection connection, String sql, int rsType, int rsConcurrency,
  ...
  public boolean executeWithFlags(int flags) throws SQLException {
    ...
    if (!hasResultSet) {
      throw new KSQLException(GT.tr("A CallableStatement was executed with nothing returned."),
        KSQLState.NO_DATA);
    }
  ...
  public boolean wasNull() throws SQLException {
    if (lastIndex == 0) {
      throw new KSQLException(GT.tr("wasNull cannot be call before fetching a result."),
  ...
  protected void checkIndex(int parameterIndex, int type1, int type2, String getName)
    ...
    if (type1 != this.testReturn[parameterIndex - 1]
      ...
      throw new KSQLException(
        ...
        KSQLState.MOST_SPECIFIC_TYPE_DOES_NOT_MATCH);
    }
  }
  ...
  private void checkIndex(int parameterIndex, boolean fetchingData) throws SQLException {
    ...
    if (fetchingData) {
      if (!returnTypeSet) {
        throw new KSQLException(GT.tr("No function outputs were registered."),
          KSQLState.OBJECT_NOT_IN_STATE);
      }
  ...
  public <T> T getObject(int parameterIndex, Class<T> type) throws SQLException {
    ...
    throw new KSQLException(GT.tr("Unsupported type conversion to {1}.", type),
