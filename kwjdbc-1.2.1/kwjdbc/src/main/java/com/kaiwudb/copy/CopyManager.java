...
/**
 * API for KaiwuDB COPY bulk data transfer.
 */
public class CopyManager {
  ...
  public CopyIn copyIn(String sql) throws SQLException {
    ...
    if (op == null || op instanceof CopyIn) {
      ...
      op.cancelCopy();
      throw new KSQLException(GT.tr("Requested CopyIn but got {0}", op.getClass().getName()),
  ...
  public CopyOut copyOut(String sql) throws SQLException {
    ...
    if (op == null || op instanceof CopyOut) {
      ...
      op.cancelCopy();
      throw new KSQLException(GT.tr("Requested CopyOut but got {0}", op.getClass().getName()),
              KSQLState.WRONG_OBJECT_TYPE);
    }
  }
  ...
  public CopyDual copyDual(String sql) throws SQLException {
    ...
    if (op == null || op instanceof CopyDual) {
      ...
      op.cancelCopy();
      throw new KSQLException(GT.tr("Requested CopyDual but got {0}", op.getClass().getName()),
          KSQLState.WRONG_OBJECT_TYPE);
    }
  }
