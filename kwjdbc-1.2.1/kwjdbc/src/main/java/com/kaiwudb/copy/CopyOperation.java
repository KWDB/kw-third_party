...
/**
 * Exchange bulk data between client and KaiwuDB database tables. See CopyIn and CopyOut for full
...
public interface CopyOperation {
   ...
   * Only implemented in KaiwuDB server version 8.2 and up. Otherwise, returns -1.
   *
