...
public class messages_it extends java.util.ResourceBundle {
  ...
  static {
    ...
    t[187] = "Il massimo valore per l''indice dei LOB di KaiwuDB è {0}. ";
    ...
    t[519] = "L''autenticazione di tipo {0} non è supportata. Verificare che nel file di configurazione kw_hba.conf sia presente l''indirizzo IP o la sottorete del client, e che lo schema di autenticazione utilizzato sia supportato dal driver.";
