...
public class messages_fr extends java.util.ResourceBundle {
  ...
  static {
    ...
    t[187] = "Les LOB KaiwuDB peuvent seulement s''indicer à: {0}";
    ...
    t[519] = "Le type d''authentification {0} n''est pas supporté. Vérifiez que vous avez configuré le fichier kw_hba.conf pour inclure l''adresse IP du client ou le sous-réseau et qu''il utilise un schéma d''authentification supporté par le pilote.";
