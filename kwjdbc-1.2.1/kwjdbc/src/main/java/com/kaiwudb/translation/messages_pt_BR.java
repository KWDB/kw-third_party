...
public class messages_pt_BR extends java.util.ResourceBundle {
  ...
  static {
    ...
    t[187] = "LOBs do KaiwuDB só podem indexar até: {0}";
    ...
    t[519] = "O tipo de autenticação {0} não é suportado. Verifique se você configurou o arquivo kw_hba.conf incluindo a subrede ou endereço IP do cliente, e se está utilizando o esquema de autenticação suportado pelo driver.";
