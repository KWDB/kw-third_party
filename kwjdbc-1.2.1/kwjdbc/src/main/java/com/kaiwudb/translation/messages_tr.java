...
public class messages_tr extends java.util.ResourceBundle {
  ...
  static {
    ...
    t[186] = "KaiwuDB LOBs can only index to: {0}";
    t[187] = "KaiwuDB LOB göstergeleri sadece {0} referans edebilir";
    ...
    t[227] = "Bu SQLXML nesnesi zaten kwsaşaltılmış.";
    ...
    t[518] = "The authentication type {0} is not supported. Check that you have configured the kw_hba.conf file to include the client''s IP address or subnet, and that it is using an authentication scheme supported by the driver.";
    t[519] = "{0} yetkinlendirme tipi desteklenmemektedir. kw_hba.conf dosyanızı istemcinin IP adresini ya da subnetini içerecek şekilde ayarlayıp ayarlamadığınızı ve sürücü tarafından desteklenen yetkilendirme yöntemlerinden birisini kullanıp kullanmadığını kontrol ediniz.";
