...
/**
 * KaiwuDB implementation of the PooledConnection interface. This shouldn't be used directly, as
 * the pooling client should just interact with the ConnectionPool instead.
 *
 * @author Aaron Mulder (ammulder@chariotsolutions.com)
 * @author Csaba Nagy (ncsaba@yahoo.com)
 * @see KWConnectionPoolDataSource
 */
public class KWPooledConnection implements PooledConnection {
   ...
   */
  public KWPooledConnection(Connection con, boolean autoCommit, boolean isXA) {
    this.con = con;
    this.autoCommit = autoCommit;
    this.isXA = isXA;
  }

  public KWPooledConnection(Connection con, boolean autoCommit) {
  ...
  public Connection getConnection() throws SQLException {
    if (con == null) {
      ...
      KSQLException sqlException =
          new KSQLException(GT.tr("This PooledConnection has already been closed."),
    ...
    try {
      ...
      /*
       * In XA-mode, autocommit is handled in KWXAConnection, because it depends on whether an
  ...
  private class ConnectionHandler implements InvocationHandler {
    ...
    public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
      ...
      // All the rest is from the Connection or KWConnection interface
      ...
      if (con == null || con.isClosed()) {
        throw new KSQLException(automatic
            ? GT.tr(
            ...
            : GT.tr("Connection has been closed."), KSQLState.CONNECTION_DOES_NOT_EXIST);
      }
      ...
      try {
        if (methodName.equals("createStatement")) {
          ...
          return Proxy.newProxyInstance(getClass().getClassLoader(),
              new Class[]{Statement.class, KWStatement.class},
              new StatementHandler(this, st));
        } else if (methodName.equals("prepareCall")) {
          Statement st = (Statement) method.invoke(con, args);
          return Proxy.newProxyInstance(getClass().getClassLoader(),
              new Class[]{CallableStatement.class, KWStatement.class},
              new StatementHandler(this, st));
        } else if (methodName.equals("prepareStatement")) {
          Statement st = (Statement) method.invoke(con, args);
          return Proxy.newProxyInstance(getClass().getClassLoader(),
              new Class[]{PreparedStatement.class, KWStatement.class},
              new StatementHandler(this, st));
        } else {
          return method.invoke(con, args);
        }
  ...
  private class StatementHandler implements InvocationHandler {
    ...
    public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
      ...
      if (st == null || st.isClosed()) {
        throw new KSQLException(GT.tr("Statement has been closed."), KSQLState.OBJECT_NOT_IN_STATE);
      }
