...
/**
 * KaiwuDB implementation of ConnectionPoolDataSource. The app server or middleware vendor should
 * provide a DataSource implementation that takes advantage of this ConnectionPoolDataSource. If
 * not, you can use the KaiwuDB implementation known as PoolingDataSource, but that should only
 ...
 */
public class KWConnectionPoolDataSource extends BaseDataSource
  ...
  public PooledConnection getPooledConnection() throws SQLException {
    return new KWPooledConnection(getConnection(), defaultAutoCommit);
  }
  ...
  public PooledConnection getPooledConnection(String user, String password) throws SQLException {
    return new KWPooledConnection(getConnection(user, password), defaultAutoCommit);
  }
