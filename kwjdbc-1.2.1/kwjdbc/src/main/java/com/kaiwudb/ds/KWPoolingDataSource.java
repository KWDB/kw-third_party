 ...
 * KaiwuDB ConnectionPoolDataSource implementation!</span> This class is provided as a
 ...
 * connection pooling, and use the KaiwuDB implementation of ConnectionPoolDataSource to provide
 ...
 */
@Deprecated
public class KWPoolingDataSource extends BaseDataSource implements DataSource {
  protected static ConcurrentMap<String, KWPoolingDataSource> dataSources =
      new ConcurrentHashMap<String, KWPoolingDataSource>();

  public static KWPoolingDataSource getDataSource(String name) {
  ...
  private KWConnectionPoolDataSource source;
  ...
  public void setDataSourceName(String dataSourceName) {
    ...
    KWPoolingDataSource previous = dataSources.putIfAbsent(dataSourceName, this);
    if (previous != null) {
  ...
  public void initialize() throws SQLException {
    synchronized (lock) {
      ...
      try {
        ...
        throw new KSQLException(GT.tr("Failed to setup DataSource."), KSQLState.UNEXPECTED_ERROR,
            e);
      }
   ...
   */
  protected KWConnectionPoolDataSource createConnectionPool() {
    return new KWConnectionPoolDataSource();
  }
  ...
  private Connection getPooledConnection() throws SQLException {
    ...
    synchronized (lock) {
      if (available == null) {
        throw new KSQLException(GT.tr("DataSource has been closed."),
