 ...
 */
public class KWTime extends Time {
  /**
  ...
  /**
   * Constructs a <code>KWTime</code> without a time zone.
   *
   * @param time milliseconds since January 1, 1970, 00:00:00 GMT; a negative number is milliseconds
   *        before January 1, 1970, 00:00:00 GMT.
   * @see Time#Time(long)
   */
  public KWTime(long time) {
    this(time, null);
  }

  /**
   * Constructs a <code>KWTime</code> with the given calendar object. The calendar object is
   ...
   * @see Time#Time(long)
   */
  public KWTime(long time, Calendar calendar) {
    super(time);
  ...
  public boolean equals(Object obj) {
    ...
    if (!(obj instanceof KWTime)) {
      return false;
    }
    KWTime other = (KWTime) obj;
    if (calendar == null) {
  ...
  @Override
  public Object clone() {
    KWTime clone = (KWTime) super.clone();
    if (getCalendar() != null) {
