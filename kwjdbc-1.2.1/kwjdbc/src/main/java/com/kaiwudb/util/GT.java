...
public class GT {
  ...
  private GT() {
    try {
      ...
      bundle = ResourceBundle.getBundle("com.kaiwudb.translation.messages");
      //#else
      bundle = ResourceBundle.getBundle("com.kaiwudb.translation.messages", Locale.getDefault(Locale.Category.DISPLAY));
      //#endif
