 ...
 */
public class KWTimestamp extends Timestamp {
  /**
  ...
  /**
   * Constructs a <code>KWTimestamp</code> without a time zone. The integral seconds are stored in
   ...
   */
  public KWTimestamp(long time) {
    this(time, null);
  }

  /**
   * <p>Constructs a <code>KWTimestamp</code> with the given time zone. The integral seconds are stored
   ...
   * @see Timestamp#Timestamp(long)
   */
  public KWTimestamp(long time, Calendar calendar) {
    super(time);
  ...
  public boolean equals(Object obj) {
    ...
    if (!(obj instanceof KWTimestamp)) {
      return false;
    }
    KWTimestamp other = (KWTimestamp) obj;
    if (calendar == null) {
  ...
  @Override
  public Object clone() {
    KWTimestamp clone = (KWTimestamp) super.clone();
    if (getCalendar() != null) {
