...
/**
 * @deprecated prefer {@link com.kaiwudb.ssl.LibPQFactory}
 */
@Deprecated
public class LibPQFactory extends com.kaiwudb.ssl.LibPQFactory implements HostnameVerifier {
   ...
   *
   * @deprecated use {@link KWjdbcHostnameVerifier}
  ...
  public static boolean verifyHostName(String hostname, String pattern) {
    ...
    return KWjdbcHostnameVerifier.INSTANCE.verifyHostName(canonicalHostname, pattern);
  }
   ...
   *
   * @deprecated use KwjdbcHostnameVerifier
  ...
  public boolean verify(String hostname, SSLSession session) {
    ...
    return KWjdbcHostnameVerifier.INSTANCE.verify(hostname, session);
  }
